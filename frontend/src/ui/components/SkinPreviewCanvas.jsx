  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (gameType === 'flappy-bird') {
        ...
        // Head Eyes (on the first segment, which was drawn last loop iteration if we went reverse, but wait... 
        // Loop above draws tail first (i=20) down to head (i=0).
        // Head is at i=0.
        // Let's redraw head extras specifically.
        const headX = centerX;
