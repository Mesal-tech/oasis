...
import { Search, Filter, Gamepad2, Play, Users, Trophy, ShoppingBag } from 'lucide-react';
...
export const GamesScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-white px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Controls */}
        <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center mb-10 sticky top-0 bg-[#09090B]/95 backdrop-blur z-30 py-4 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 border-b border-[#27272A]">
          {/* Search */}
