...
import { Trophy, Medal, Crown, Shield, Hexagon, ShoppingBag } from 'lucide-react';
...
export const LeaderboardScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090B] text-white px-4 sm:px-6 lg:px-8 py-6 lg:py-12 overflow-y-auto">
      {/* Header */}
            ...
            <div className="sm:hidden grid grid-cols-1 gap-6 max-w-md mx-auto">
              {topThree.map((entry, idx) => (
                <div key={idx} className={`relative bg-[#121215] border rounded-2xl p-6 text-center ${idx === 0 ? 'border-[#FF5D2E] shadow-lg shadow-[#FF5D2E]/20' : 'border-[#27272A]'}`}>
                  ...
                  <div className="font-bold text-lg">{entry.player.username}</div>
                    ...
                    >
                      ...
                      <div className="col-span-5 flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-[#52525B]">Global Rank</div>
                        </div>
                      </div>
